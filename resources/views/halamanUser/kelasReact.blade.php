  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-center mt-5 flex-wrap">
      <div class="card text-center mx-4 my-4" style="width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title head-card-tools">React JS</h5>
          <a href="https://reactjs.org/docs/getting-started.html" target="__blank" class=" download-card-tools">Install</a>
        </div>
      </div>
      <div class="card text-center mx-4 my-4" style="width: 18rem;">
