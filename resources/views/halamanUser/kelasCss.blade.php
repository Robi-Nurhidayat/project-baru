    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center mt-5 flex-wrap">
            <div class="card text-center mx-4 my-4" style="width: 18rem;">
                <img src="{{ asset('img/logotools/css.png') }}" class="align-self-center card-img-profile mt-4" width="80px" alt="...">
                <div class="card-body">
                    <h5 class="card-title head-card-tools">CSS</h5>
                    <a href="https://developer.mozilla.org/en-US/docs/Web/CSS?retiredLocale=id" target="__blank" class=" download-card-tools">Documentation</a>
                </div>
            </div>
            <div class="card text-center mx-4 my-4" style="width: 18rem;">
