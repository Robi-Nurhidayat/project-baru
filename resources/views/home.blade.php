...
<div class="jumbotron bg-white mx-5 my-5">
    <div class="row">
        <div class="col-md-5">
            ...
            <p class="lead mb-4">Belajar cerdas seputar programming bersama ITCourse dan dapatkan pengetahuan untuk membangun masa depan anda yang lebih terarah</p>

            <a class="btn btn-outline-primary" href="#" role="button">Get started</a>
            <a class="btn btn btn-outline-secondary" href="#" role="button">Course List</a>
        </div>
